<div class="content-wrapper">
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Suppression de contact</li>
    </ol>
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-plus"></i> Suppression de contact</div>
        <div class="card-body">

            <div class="loadertext">
              Contact supprimé avec succès ! Redirection en cours ...<br>
