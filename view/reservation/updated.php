<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Réservation modifiée</li>
    </ol>
    <!-- Example DataTables Card-->
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-plus"></i> Réservation modifiée</div>
        <div class="card-body">
          <div class="loadertext">
            Réservation modifiée avec succès ! Redirection en cours ...<br>
